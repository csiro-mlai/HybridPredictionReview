...
* challenge: there is still terrible prediction on the test data.  New experiments support the idea that the problem here is not the code bug, but that out-of-distribution predictions are terrible. If the input data is unphysical, the output is meaningless. (Predictions from the validation set are pretty good, just no the synthetic examples)
